...
\input{TexFiles/00_macros_equations}
...
% Auxiliary pages
%================================================================%
%The first pages are regulated by your institution's layout guidelines.
%Check those to ensure the format is up to date and complete.
...
%Abstract. Word length is regulated by your institution's layout guidelines.
...
% Change report (Draft 4 to Draft 5)
\cleardoublepage
\input{TexFiles/change-report}
...
% Compact thesis-wide list of frequent terms and abbreviations (before Chapter 1)
\thispagestyle{empty}
\cleardoublepage
\thispagestyle{plain}
\glsaddall
